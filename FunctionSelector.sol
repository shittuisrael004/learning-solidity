...
// ```solidity addr.call(abi.encodeWithSignature("transfer(address,uint256)", 0xSomeAddress, 123)) ```
...
// The bytes are found in the msg.Data. Here is how the function selector is computed.
